...
$mpdf->writehtml(' <div style="text-align: center;"> <img src="../img/logo1.png"  width="170">  <h1 >Lab ACE</h1></div>'.'<div style="text-align: center; font-size: 30px;">------------------------HEMATOLOGIA ------------------------</div>'.'<br>'."Hemoglobina ".$hemoglobina." g/dl -----------------------------------------------------------------------------  Referencia: 12-17".'<br>'.'<br>'.
